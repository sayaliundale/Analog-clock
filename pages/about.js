    ...
    <div className={styles.container}>
      ...
      <div className={styles.text}>
        <p>
          ...
          development of students in the field of computing.The Chapter provides
          a platform for students to showcase their talents.It facilitates
          community and individual growth in the computing profession.The
